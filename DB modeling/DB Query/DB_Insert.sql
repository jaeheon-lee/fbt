...
insert into vote_match_result(vote_match_result_id, vote_match_id, attendance, team_member_id, email) 
values('30', '3', '1', NULL, 'bioman16@gmail.com');
...
values(1, '1-bioman1@gmail.com', 11, NULL, 1, NULL, 0, NULL, NULL, NULL);
insert into entry(entry_id, team_member_id, match_schedule_id, email, team_id, attendance, type, match_score, goal, assist)
values(2, '1-bioman2@gmail.com', 11, NULL, 1, NULL, 0, NULL, NULL, NULL);
insert into entry(entry_id, team_member_id, match_schedule_id, email, team_id, attendance, type, match_score, goal, assist)
values(3, '1-bioman3@gmail.com', 11, NULL, 1, NULL, 0, NULL, NULL, NULL);
insert into entry(entry_id, team_member_id, match_schedule_id, email, team_id, attendance, type, match_score, goal, assist)
values(4, '1-bioman4@gmail.com', 11, NULL, 1, NULL, 0, NULL, NULL, NULL);
insert into entry(entry_id, team_member_id, match_schedule_id, email, team_id, attendance, type, match_score, goal, assist)
values(5, '1-bioman5@gmail.com', 11, NULL, 1, NULL, 0, NULL, NULL, NULL);
