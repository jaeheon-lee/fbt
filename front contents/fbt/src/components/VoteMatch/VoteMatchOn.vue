        ...
        <v-col xl="6" lg="8" cols="12" class="pa-0 ma-0">
          ...
          >
              ...
              <v-col offset="2" cols="8">
                ...
                <v-row class="justify-center ma-0 pa-0 mt-4">
                  <v-btn
                    ...
                    color="#AD1457"
                    class="mr-1"
                    @click.stop="doVote(vote.voteMatchId, 1)"
                    >참 석</v-btn
                  >
                  <v-btn
                    small
                    ...
                    class="ml-1"
                    @click.stop="doVote(vote.voteMatchId, 0)"
                    >불참석</v-btn
                  >
                </v-row>
                <!--투표버튼 끝-->
            ...
            <div id="member-invite">
              ...
              <v-divider></v-divider>
              <!-- 명단 -->
              <div id="voted-Member-list" v-if="activeMemberList == i">
              ...
              <!-- 지인 초대 -->
              <v-divider></v-divider>
              <div class="ml-6" id="invite-friend" v-if="activeFriendList == i">
                <v-row>
...
<style scroped src="@/assets/css/vote-match/VoteMatchOn.css"></style>
<script scoped src="@/assets/js/vote-match/VoteMatchOn.js"></script>
