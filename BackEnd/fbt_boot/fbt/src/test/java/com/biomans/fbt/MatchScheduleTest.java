...
//		matchSchedule.setMatchType("11:11");
//		matchSchedule.setStadiumType("흙");
//		matchSchedule.setStadiumX(127.076336885325);
//		matchSchedule.setStadiumY(37.5280242726795);
////		
//		sqlsession.insert(ns+"addMatchSchedule", matchSchedule);
		
		int id = sqlsession.selectOne(ns+"showLatestMatchScheduleIdById", 1);
