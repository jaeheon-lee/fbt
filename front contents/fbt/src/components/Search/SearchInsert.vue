  ...
  <div>
    <v-container fluid class="py-0 my-7 px-0 mx-0">
      ...
      <v-row fluid justify="center" class="py-0 my-0 px-0 mx-5">
        <v-col xl="6" lg="8" cols="12" class="pa-0 ma-0">
              ...
              <v-col cols="12" class="text-left pa-0">
                ...
                >
                  <textarea
                    ...
                    cols="10000"
                    placeholder="매치글에 남기고 싶은 말을 입력해주세요"
                    style="color:#ffffff"
                  ></textarea>
                </v-row>
              </v-col>
          ...
          <v-row class="mx-0 px-0 pt-3 justify-center">
            <v-btn elevation="3" @click="addSearch">매치등록하기</v-btn>
          </v-row>
          <!-- 제출 버튼 끝 -->
        </v-col>
      </v-row>
      <v-dialog v-model="dialogNaver">
        <naver-link
          :type="'search'"
          :matchSchedule="search.matchSchedule"
          @close="closeNaver"
        ></naver-link>
      </v-dialog>
    </v-container>
...
<script scoped src="@/assets/js/search/SearchInsert.js"></script>
