      ...
      <v-row>
        ...
        >
          ...
          <v-card class="mx-5 py-4" v-if="page == 1">
            ...
            <v-btn class="mx-12" color="#6920A3" @click="changePass" v-else
              >비밀번호 변경하기</v-btn
            >
            <!-- 비밀번호 확인 끝 -->
            <!-- 이름 -->
          ...
          <v-card class="mx-5 py-4" v-if="page == 2">
            ...
            <v-row justify="end" class="mt-6 mr-11">
              ...
              <v-btn
                ...
                >완료</v-btn
              >
              <v-btn color="#6820A3" @click="updateUser" v-else>수정</v-btn>
            </v-row>
            <!-- 다음 버튼 끝 -->
          </v-card>
          <!-- page2 끝 -->
...
<script scoped src="@/assets/js/signin/SigninBody.js"></script>
